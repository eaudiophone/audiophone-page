	...
	<div class="row sec align-items-center">
		...
		<div class="col-md-8 col-12 p-3">
			<p class="text-justify text">
				Contamos con equipos de gamma media y alta, como consolas, masterizadores de audio, estructuras satelitales de cornetas de audio, bases, parales, microfonos, luces de minitecas, hasta equipos de orquesta.
			</p>
		</div>
	</div>
</div>
<div class="container border-d">
	<div class="row sec align-items-center">
		<div class="col-md-8 col-12 p-3">
			<p class="text-justify text">
